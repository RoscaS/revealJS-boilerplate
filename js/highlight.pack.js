...
!function (e) {
  var n = 'object' == typeof window && window || 'object' == typeof self &&
    self;
  'undefined' != typeof exports ? e(exports) : n &&
    (n.hljs = e({}), 'function' == typeof define && define.amd &&
  ...
  function g(e) {
    ...
    for (n in e) t[n] = e[n];
    return r.forEach(function (e) {for (n in e) t[n] = e[n];}), t;
  }
  ...
  function R(e) {
    ...
    return function e(
      n, t) {
      for (var r = n.firstChild; r; r = r.nextSibling) 3 === r.nodeType
    ...
    !function n(t, e) {
      if (!t.compiled) {
        if (t.compiled = !0, t.k = t.k || t.bK, t.k) {
          ...
          var a = {};
          'string' == typeof t.k ? r('keyword', t.k) : u(t.k).
            forEach(function (e) {r(e, t.k[e]);}), t.k = a;
        }
        t.lR = c(t.l || /\w+/, !0), e &&
        (t.bK && (t.b = '\\b(' + t.bK.split(' ').join('|') + ')\\b'), t.b ||
        (t.b = /\B|\b/), t.bR = c(t.b), t.endSameAsBegin && (t.e = t.b), t.e ||
        t.eW || (t.e = /\B|\b/), t.e && (t.eR = c(t.e)), t.tE = s(t.e) ||
          '', t.eW && e.tE && (t.tE += (t.e ? '|' : '') + e.tE)), t.i &&
        (t.iR = c(t.i)), null == t.r && (t.r = 1), t.c ||
        (t.c = []), t.c = Array.prototype.concat.apply([], t.c.map(
          function (e) {
            return function (n) {
              return n.v && !n.cached_variants && (n.cached_variants = n.v.map(
                function (e) {return g(n, {v: null}, e);})), n.cached_variants ||
              n.eW && [g(n)] || [n];
            }('self' === e ? t : e);
          })), t.c.forEach(function (e) {n(e, t);}), t.starts && n(t.starts, e);
        var i = t.c.map(
          function (e) {return e.bK ? '\\.?(?:' + e.b + ')\\.?' : e.b;}).
          concat([t.tE, t.i]).
          map(s).
          filter(Boolean);
        t.t = i.length ? c(function (e, n) {
          for (var t = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./, r = 0, a = '', i = 0; i <
          e.length; i++) {
            var o = r,
              c = s(e[i]);
            for (0 < i && (a += n); 0 < c.length;) {
              ...
              a += c.substring(0, u.index), c = c.substring(
                u.index + u[0].length), '\\' == u[0][0] && u[1] ? a += '\\' +
  ...
  function C(e, n, i, t) {
    ...
    function o() {
      E += null != l.sL ? function () {
        ...
        return 0 < l.r && (R += n.r), e && (f[l.sL] = n.top), c(n.language,
          n.value, !1, !0,
        );
      }() : function () {
        var e,
          ...
          o;
        if (!l.k) return _(g);
        for (r = '', n = 0, l.lR.lastIndex = 0, t = l.lR.exec(g); t;) r += _(
          g.substring(n, t.index)), a = l, i = t, void 0, o = s.cI
                                                              ? i[0].toLowerCase()
                                                              : i[0], (e = a.k.hasOwnProperty(
          o) && a.k[o]) ? (R += e[1], r += c(e[0], _(t[0]))) : r += _(
          t[0]), n = l.lR.lastIndex, t = l.lR.exec(g);
    ...
    function r(e, n) {
      ...
      var t = function (e, n) {
        var t,
          r,
          a;
        for (t = 0, r = n.c.length; t < r; t++) if (v(n.c[t].bR,
          e,
        )) return n.c[t].endSameAsBegin &&
        (n.c[t].eR = (a = n.c[t].bR.exec(e)[0], new RegExp(
          a.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'), 'm'))), n.c[t];
      }(n, l);
      if (t) return t.skip ? g += n : (t.eB && (g += n), o(), t.rB || t.eB ||
      (g = n)), u(t), t.rB ? 0 : n.length;
      ...
      if (r) {
        var a = l;
        for (a.skip ? g += n : (a.rE || a.eE || (g += n), o(), a.eE &&
        (g = n)); l.cN && (E += b), l.skip || l.sL ||
        (R += l.r), (l = l.parent) !== r.parent;) ;
        return r.starts &&
        (r.endSameAsBegin && (r.starts.eR = r.eR), u(r.starts)), a.rE
                                                                 ? 0
                                                                 : n.length;
      }
      if (function (e, n) {return !i && v(n.iR, e);}(n, l)) throw new Error(
    ...
    var g = '',
      R = 0;
    try {
      for (var d, p, M = 0; l.t.lastIndex = M, d = l.t.exec(n);) p = r(
        n.substring(M, d.index), d[0]), M = d.index + p;
  ...
  function o(e) {
    var n,
      ...
      o = function (e) {
        var n,
          ...
          a,
          i = e.className + ' ';
        if (i += e.parentNode ? e.parentNode.className : '', t = s.exec(
          i)) return B(t[1]) ? t[1] : 'no-highlight';
        for (n = 0, r = (i = i.split(/\s+/)).length; n < r; n++) if (l(
          a = i[n]) || B(a)) return a;
      }(e);
    l(o) || (h.useBR
             ? (n = document.createElementNS('http://www.w3.org/1999/xhtml',
        'div',
      )).innerHTML = e.innerHTML.replace(/\n/g, '').replace(/<br[ \/]*>/g, '\n')
             : n = e, i = n.textContent, r = o ? C(o, i, !0) : O(i), (t = R(
      n)).length &&
    ((a = document.createElementNS('http://www.w3.org/1999/xhtml',
      ...
      function o() {
        return e.length && n.length ? e[0].offset !== n[0].offset
      ...
      for (; e.length || n.length;) {
        ...
        if (a += _(t.substring(r, l[0].offset)), r = l[0].offset, l === e) {
          for (i.reverse().forEach(u); s(l.splice(0, 1)[0]), (l = o()) === e &&
          l.length && l[0].offset === r;) ;
          i.reverse().forEach(c);
        } else 'start' === l[0].event ? i.push(l[0].node) : i.pop(), s(
          l.splice(0, 1)[0]);
      }
      return a + _(t.substr(r));
    }(t, R(a), i)), r.value = d(
      r.value), e.innerHTML = r.value, e.className = function (
      e, n, t) {
      var r = n ? c[n] : t,
        a = [e.trim()];
      return e.match(/\bhljs\b/) || a.push('hljs'), -1 === e.indexOf(r) &&
      a.push(r), a.join(' ').trim();
  ...
  return a.highlight = C, a.highlightAuto = O, a.fixMarkup = d, a.highlightBlock = o, a.configure = function (e) {
    ...
    i: '\\n',
    c: [a.BE],
  }, a.PWM = a.PHRASAL_WORDS_MODE = {b: /\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/}, a.C = a.COMMENT = function (
    e, n, t) {
    var r = a.inherit({cN: 'comment', b: e, e: n, c: []}, t || {});
    return r.c.push(a.PWM), r.c.push(
      {cN: 'doctag', b: '(?:TODO|FIXME|NOTE|BUG|XXX):', r: 0}), r;
  }, a.CLCM = a.C_LINE_COMMENT_MODE = a.C('//',
    '$',
  ), a.CBCM = a.C_BLOCK_COMMENT_MODE = a.C('/\\*',
    '\\*/',
  ), a.HCM = a.HASH_COMMENT_MODE = a.C('#', '$'), a.NM = a.NUMBER_MODE = {
    cN: 'number',
    b: a.NR,
    r: 0,
...
hljs.registerLanguage('cs', function (e) {
  var i = {
    ...
    l = e.inherit(b, {i: /\n/, c: [{b: '{{'}, {b: '}}'}, {b: '""'}, n]});
  c.c = [b, s, t, e.ASM, e.QSM, r, e.CBCM], n.c = [
    l,
    s,
    a,
    e.ASM,
